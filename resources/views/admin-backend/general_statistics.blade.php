                        ...
                        <table class="table table-flush" id="datatable-search">
                            ...
                            <tbody>
                                ...
                                @foreach ($users as $user)
                                    <tr>
                                        <td class="text-sm font-weight-normal">{{$user->subscription_avail_date}}</td>
                                        <td class="text-sm font-weight-normal">{{$user->subscription_level}}</td>
